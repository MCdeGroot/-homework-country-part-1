...
async function fetchCountries() {
    ...
    // op bovenstaande manier kunnen we uit een endpoint data weergeven in een applicatie//
        ...
        if (error.response.status === 404) errorMessage.textContent = "Page not found | error 404";
        else if (error.response.status === 500) errorMessage.textContent = "Internal server error | error 500";
    }
}
fetchCountries();
...
var Buffer = require("7c287034e68e526f").Buffer;
"use strict";
/**
...
},{"7c287034e68e526f":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("8bf08e12930fb402");
var ieee754 = require("7cb59f3d66194a31");
...
},{"8bf08e12930fb402":"eIiSV","7cb59f3d66194a31":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
